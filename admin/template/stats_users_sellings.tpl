	...
	<form action="{{$page_name}}" method="get" class="form_dgf">
		<div class="dgf">
			<table>
				<tr>
					...
					<td class="dgf_label">{{$lang.stats.users_purchases_filter_group_by}}:</td>
					<td class="dgf_control">
						<select name="se_group_by" class="dgf_switcher">
							<option value="user" {{if $smarty.session.save.$page_name.se_group_by=='user'}}selected="selected"{{/if}}>{{$lang.stats.users_purchases_filter_group_by_user}}</option>
							<option value="video" {{if $smarty.session.save.$page_name.se_group_by=='video'}}selected="selected"{{/if}}>{{$lang.stats.users_purchases_filter_group_by_video}}</option>
							<option value="album" {{if $smarty.session.save.$page_name.se_group_by=='album'}}selected="selected"{{/if}}>{{$lang.stats.users_purchases_filter_group_by_album}}</option>
							<option value="profile" {{if $smarty.session.save.$page_name.se_group_by=='profile'}}selected="selected"{{/if}}>{{$lang.stats.users_purchases_filter_group_by_profile}}</option>
							<option value="dvd" {{if $smarty.session.save.$page_name.se_group_by=='dvd'}}selected="selected"{{/if}}>{{$lang.stats.users_purchases_filter_group_by_dvd}}</option>
							<option value="log" {{if $smarty.session.save.$page_name.se_group_by=='log'}}selected="selected"{{/if}}>{{$lang.stats.users_purchases_filter_group_by_full}}</option>
						</select>
					</td>
					<td class="dgf_control">
		...
		<div class="dgf dgf_advanced_filters {{if $table_filtered==0}}hidden{{/if}}">
			<table class="dgf_filter">
				<tr>
					<td class="dgf_label {{if $smarty.session.save.$page_name.se_user!=''}}dgf_selected{{/if}}">{{$lang.stats.users_purchases_field_user}}:</td>
					<td class="dgf_control">
						<div class="insight">
							<div class="js_params">
			...
			<table class="dgf_filter">
				<tr>
					<td class="dgf_label {{if $smarty.session.save.$page_name.se_reseller_code!=''}}dgf_selected{{/if}}">{{$lang.stats.users_purchases_field_reseller_code}}:</td>
