...
<form action="{{$page_name}}" method="post">
	...
	<table class="de">
		...
		<tr>
			<td class="de_header" colspan="2"><div><a href="{{$page_name}}">{{$lang.settings.submenu_option_formats_screenshots_list}}</a> / {{if $smarty.get.action=='add_new'}}{{$lang.settings.format_screenshot_add}}{{else}}{{$lang.settings.format_screenshot_edit|replace:"%1%":$smarty.post.title}}{{/if}}</div></td>
		</tr>
		<tr>
			<td class="de_separator" colspan="2"><div>{{$lang.settings.format_screenshot_divider_general}}</div></td>
		</tr>
		<tr>
			...
			<td class="de_control">
				<div class="de_vis_sw_select">
					<select id="group_id" name="group_id" {{if $smarty.get.action!='add_new'}}disabled="disabled"{{/if}}>
						<option value="1" {{if $smarty.post.group_id==1}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_group_main}}</option>
						<option value="2" {{if $smarty.post.group_id==2}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_group_timeline}}</option>
						<option value="3" {{if $smarty.post.group_id==3}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_group_posters}}</option>
					</select>
		...
		<tr>
			...
			<td class="de_control">
				<select name="image_type" {{if $smarty.get.action!='add_new'}}disabled="disabled"{{/if}}>
					<option value="0" {{if $smarty.post.image_type==0}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_image_type_jpg}}</option>
					<option value="1" {{if $smarty.post.image_type==1}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_image_type_webp}}</option>
				</select>
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.settings.format_screenshot_field_image_type_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr class="group_id_1 group_id_2">
			...
			<td class="de_control">
				...
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.settings.format_screenshot_field_im_options_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr class="group_id_1 group_id_3">
			...
			<td class="de_control">
				<textarea name="im_options_manual" class="dyn_full_size" cols="30" rows="3">{{$smarty.post.im_options_manual}}</textarea>
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.settings.format_screenshot_field_im_options_hint}}</span>
				{{/if}}
			</td>
		...
		<tr>
			...
			<td class="de_control">
				<table class="control_group">
					...
					<tr class="group_data">
						<td class="nowrap">{{$lang.settings.format_screenshot_field_aspect_ratio_horizontal}}:</td>
						<td>
							<div class="de_vis_sw_select">
								<select id="aspect_ratio_id" name="aspect_ratio_id">
									<option value="1" {{if $smarty.post.aspect_ratio_id==1}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_preserve_source}}</option>
									<option value="2" {{if $smarty.post.aspect_ratio_id==2}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_convert_to_target}}</option>
									<option value="3" {{if $smarty.post.aspect_ratio_id==3}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_dynamic_size}}</option>
								</select>
								<span class="aspect_ratio_id_2">
									&nbsp;&nbsp;
									{{$lang.settings.format_screenshot_field_aspect_ratio_gravity}}:
									<select name="aspect_ratio_gravity">
										<option value="" {{if $smarty.post.aspect_ratio_gravity==''}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_gravity_center}}</option>
										<option value="North" {{if $smarty.post.aspect_ratio_gravity=='North'}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_gravity_north}}</option>
										<option value="West" {{if $smarty.post.aspect_ratio_gravity=='West'}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_gravity_west}}</option>
										<option value="East" {{if $smarty.post.aspect_ratio_gravity=='East'}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_gravity_east}}</option>
										<option value="South" {{if $smarty.post.aspect_ratio_gravity=='South'}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_gravity_south}}</option>
									</select>
								</span>
							</div>
						</td>
					...
					<tr class="group_data">
						<td class="nowrap">{{$lang.settings.format_screenshot_field_aspect_ratio_vertical}}:</td>
						<td>
							<div class="de_vis_sw_select">
								<select id="vertical_aspect_ratio_id" name="vertical_aspect_ratio_id">
									<option value="1" {{if $smarty.post.vertical_aspect_ratio_id==1}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_preserve_source}}</option>
									<option value="2" {{if $smarty.post.vertical_aspect_ratio_id==2}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_convert_to_target}}</option>
									<option value="3" {{if $smarty.post.vertical_aspect_ratio_id==3}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_dynamic_size}}</option>
								</select>
								<span class="vertical_aspect_ratio_id_2">
									&nbsp;&nbsp;
									{{$lang.settings.format_screenshot_field_aspect_ratio_gravity}}:
									<select name="vertical_aspect_ratio_gravity">
										<option value="" {{if $smarty.post.vertical_aspect_ratio_gravity==''}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_gravity_center}}</option>
										<option value="North" {{if $smarty.post.vertical_aspect_ratio_gravity=='North'}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_gravity_north}}</option>
										<option value="West" {{if $smarty.post.vertical_aspect_ratio_gravity=='West'}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_gravity_west}}</option>
										<option value="East" {{if $smarty.post.vertical_aspect_ratio_gravity=='East'}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_gravity_east}}</option>
										<option value="South" {{if $smarty.post.vertical_aspect_ratio_gravity=='South'}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_aspect_ratio_gravity_south}}</option>
									</select>
								</span>
							</div>
						</td>
		...
		<tr>
			...
			<td class="de_control">
				<select name="interlace_id">
					<option value="0" {{if $smarty.post.interlace_id==0}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_interlace_none}}</option>
					<option value="1" {{if $smarty.post.interlace_id==1}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_interlace_line}}</option>
					<option value="2" {{if $smarty.post.interlace_id==2}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_interlace_plane}}</option>
				</select>
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.settings.format_screenshot_field_interlace_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
			...
			<td class="de_control">
				...
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.settings.format_screenshot_field_comment_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
			...
			<td class="de_control">
				<div class="de_lv_pair"><input type="checkbox" name="is_create_zip" value="1" {{if $smarty.post.is_create_zip==1}}checked="checked"{{/if}}/><label>{{$lang.settings.format_screenshot_field_create_zip_yes}}</label></div>
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.settings.format_screenshot_field_create_zip_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
			<td class="de_separator" colspan="2"><div>{{$lang.settings.format_screenshot_divider_watermark}}</div></td>
		</tr>
		<tr>
			...
			<td class="de_control">
				...
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.settings.format_screenshot_field_watermark_image_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
			...
			<td class="de_control">
				<select name="watermark_position_id">
					<option value="0" {{if $smarty.post.watermark_position_id==0}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_watermark_position_random}}</option>
					<option value="1" {{if $smarty.post.watermark_position_id==1}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_watermark_position_top_left}}</option>
					<option value="2" {{if $smarty.post.watermark_position_id==2}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_watermark_position_top_right}}</option>
					<option value="3" {{if $smarty.post.watermark_position_id==3}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_watermark_position_bottom_right}}</option>
					<option value="4" {{if $smarty.post.watermark_position_id==4}}selected="selected"{{/if}}>{{$lang.settings.format_screenshot_field_watermark_position_bottom_left}}</option>
				</select>
			</td>
		</tr>
		<tr>
			...
			<table>
				...
				{{section name="groups" start=0 step=1 loop=3}}
					...
					{{else}}
						<tr class="dg_data">
							<td class="dg_selector"><input type="checkbox" disabled="disabled"/></td>
							<td colspan="{{$group_colspan}}">{{$lang.settings.format_screenshot_field_group_no_formats}}</td>
						</tr>
					{{/if}}
