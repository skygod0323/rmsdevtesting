...
<form action="{{$page_name}}" method="post">
	...
	<table class="de">
		...
		<tr>
			<td class="de_header" colspan="2"><div><a href="videos.php">{{$lang.videos.submenu_option_videos_list}}</a> / {{$lang.videos.mass_edit_videos_header}}</div></td>
		</tr>
		<tr>
			<td class="de_label">{{$lang.videos.mass_edit_videos_field_selected_videos}}:</td>
			<td class="de_control">
				{{if $videos_count_all==1}}
					<strong><span class="highlighted_text">{{$lang.videos.mass_edit_videos_field_selected_videos_all}} ({{$videos_count}})</span></strong>
				{{else}}
					{{$videos_count}}
				{{/if}}
			</td>
		...
		<tr>
			<td class="de_separator" colspan="2"><div>{{$lang.videos.mass_edit_videos_divider_general}}</div></td>
		</tr>
		<tr>
			<td class="de_label">{{$lang.videos.mass_edit_videos_field_directory}}:</td>
			<td class="de_control">
				<div class="de_lv_pair de_vis_sw_checkbox"><input type="checkbox" id="regenerate_directories" name="regenerate_directories" value="1" {{if $disallow_directory_change==1}}disabled="disabled"{{/if}}/> <label>{{$lang.videos.mass_edit_videos_field_directory_regenerate}}</label></div>
				...
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_directory_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="de_control">
				<div class="de_vis_sw_select">
					...
					{{if $smarty.session.userdata.is_expert_mode==0}}
						<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_type_hint}}</span>
					{{/if}}
				</div>
			</td>
		</tr>
		{{if $config.installation_type>=2}}
			...
			<tr>
				...
				<td class="de_control">
					...
					{{if $smarty.session.userdata.is_expert_mode==0}}
						<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_tokens_cost_hint}}</span>
					{{/if}}
				</td>
			</tr>
		{{/if}}
		...
		<tr>
			...
			<td class="de_control">
				<select name="content_source_id">
					<option value="">{{$lang.videos.mass_edit_videos_do_not_change}}</option>
					<option value="-1">{{$lang.videos.mass_edit_videos_field_content_source_reset}}</option>
		...
		<tr>
			...
			<td class="de_control">
				<div class="insight">
					...
					<input type="text" name="dvd" maxlength="255" class="fixed_300" value=""/>
				</div>
			</td>
		</tr>
		<tr>
			...
			<td class="de_control">
				{{if $config.relative_post_dates=='true'}}
					<div class="de_vis_sw_radio">
						<table class="control_group">
							<tr>
								<td>
									<div class="de_lv_pair"><input id="post_date_option_fixed" type="radio" name="post_date_option" value="0" checked="checked"/><label>{{$lang.videos.mass_edit_videos_field_post_date_option_fixed}}</label></div>
									{{$lang.videos.mass_edit_videos_field_post_date_from}}: {{html_select_date prefix='post_date_from_' start_year='+2' end_year='2000' reverse_years="1" field_order=DMY time='0000-00-00' all_extra='class="post_date_option_fixed"'}}&nbsp;&nbsp;
									{{$lang.videos.mass_edit_videos_field_post_date_to}}: {{html_select_date prefix='post_date_to_' start_year='+2' end_year='2000' reverse_years="1" field_order=DMY time='0000-00-00' all_extra='class="post_date_option_fixed"'}}
									{{if $smarty.session.userdata.is_expert_mode==0}}
										<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_post_date_hint}}</span>
									{{/if}}
								</td>
							</tr>
							<tr>
								<td>
									<div class="de_lv_pair"><input id="post_date_option_relative" type="radio" name="post_date_option" value="1"/><label>{{$lang.videos.mass_edit_videos_field_post_date_option_relative}}</label></div>
									{{$lang.videos.mass_edit_videos_field_post_date_from}}: <input type="text" name="relative_post_date_from" class="fixed_100 post_date_option_relative" maxlength="5"/>&nbsp;&nbsp;
									{{$lang.videos.mass_edit_videos_field_post_date_to}}: <input type="text" name="relative_post_date_to" class="fixed_100 post_date_option_relative" maxlength="5"/>
									{{if $smarty.session.userdata.is_expert_mode==0}}
										<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_post_date_hint2}}</span>
									{{/if}}
								</td>
							</tr>
						</table>
				...
				{{else}}
					{{$lang.videos.mass_edit_videos_field_post_date_from}}: {{html_select_date prefix='post_date_from_' start_year='+2' end_year='2000' reverse_years="1" field_order=DMY time='0000-00-00'}}&nbsp;&nbsp;
					{{$lang.videos.mass_edit_videos_field_post_date_to}}: {{html_select_date prefix='post_date_to_' start_year='+2' end_year='2000' reverse_years="1" field_order=DMY time='0000-00-00'}}
					{{if $smarty.session.userdata.is_expert_mode==0}}
						<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_post_date_hint}}</span>
					{{/if}}
				{{/if}}
		...
		<tr>
			...
			<td class="de_control">
				<div class="de_lv_pair de_vis_sw_checkbox"><input id="post_time_change" type="checkbox" name="post_time_change" value="1"/><label>{{$lang.videos.mass_edit_videos_field_post_time_change}}</label></div>
				{{$lang.videos.mass_edit_videos_field_post_time_from}}: <input type="text" name="post_time_from" maxlength="5" class="post_time_change_on" size="4" value="00:00"/>&nbsp;&nbsp;
				{{$lang.videos.mass_edit_videos_field_post_time_to}}: <input type="text" name="post_time_to" maxlength="5" class="post_time_change_on" size="4" value="23:59"/>
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_post_time_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
			...
			<td class="de_control">
				...
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_rating_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
			...
			<td class="de_control">
				...
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_visits_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
			...
			<td class="de_control">
				...
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_lock_website_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
			...
			<td class="de_control">
				...
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_review_flag_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="de_separator" colspan="2"><div>{{$lang.videos.mass_edit_videos_divider_categorization}}</div></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="de_label">{{$lang.videos.mass_edit_videos_field_flag_clear}}:</td>
			<td class="de_control">
				<select name="flag_id">
					<option value="">{{$lang.videos.mass_edit_videos_do_not_change}}</option>
		...
		<tr>
			<td class="de_separator" colspan="2"><div>{{$lang.videos.mass_edit_videos_divider_content}}</div></td>
		</tr>
		<tr>
			<td class="de_label">{{$lang.videos.mass_edit_videos_field_sources}}:</td>
			<td class="de_control">
				<div class="de_lv_pair"><input type="checkbox" name="delete_source_files" value="1"/> <label>{{$lang.videos.mass_edit_videos_field_sources_delete}}</label></div>
			</td>
		</tr>
		<tr>
			...
			<td class="de_control">
				<table class="control_group">
					<tr>
						<td>
							{{foreach item=item_group from=$list_formats_videos_create|smarty:nodefaults}}
								{{foreach item=item from=$item_group|smarty:nodefaults}}
									<div class="de_lv_pair"><input type="checkbox" name="video_format_create_ids[]" value="{{$item.postfix}}"/><label>{{$item.title}}{{if $item.has_watermark==1}} ({{$lang.videos.mass_edit_videos_field_format_video_create_watermarks_flag}}){{/if}}</label></div>
								{{/foreach}}
							{{/foreach}}
							{{if $smarty.session.userdata.is_expert_mode==0}}
								<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_format_video_create_hint}}</span>
							{{/if}}
						</td>
					</tr>
					<tr>
						<td>
							<div class="de_lv_pair"><input type="checkbox" name="video_format_create_disable_wm" value="1"/><label>{{$lang.videos.mass_edit_videos_field_format_video_create_watermarks}}</label></div>
							{{if $smarty.session.userdata.is_expert_mode==0}}
								<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_format_video_create_watermarks_hint}}</span>
							{{/if}}
						</td>
					</tr>
				</table>
		...
		<tr>
			...
			<td class="de_control">
				{{foreach item=item_group from=$list_formats_videos_delete|smarty:nodefaults}}
					{{foreach item=item from=$item_group|smarty:nodefaults}}
						<div class="de_lv_pair"><input type="checkbox" name="video_format_delete_ids[]" value="{{$item.postfix}}"/><label>{{$item.title}}</label></div>
					{{/foreach}}
				{{/foreach}}
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_format_video_delete_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
			...
			<td class="de_control">
				<div class="de_vis_sw_select">
					<select id="video_format_upload_id" name="video_format_upload_id">
						<option value="">{{$lang.videos.mass_edit_videos_do_not_change}}</option>
					...
					<div class="de_fu">
						...
						<input type="text" name="video_format_upload_file" class="fixed_300 {{$enable_upload_class}}" maxlength="100" readonly="readonly"/>
		...
		<tr>
			<td class="de_label">{{$lang.videos.mass_edit_videos_field_format_video_duration}}:</td>
			<td class="de_control">
				<select name="video_format_duration_id">
					<option value="">{{$lang.videos.mass_edit_videos_do_not_change}}</option>
					{{foreach item=item_group from=$list_formats_videos_duration|smarty:nodefaults}}
						<optgroup label="{{if $item_group[0].video_type_id==0}}{{$lang.videos.common_formats_standard}}{{elseif $item_group[0].video_type_id==1}}{{$lang.videos.common_formats_premium}}{{/if}}">
							{{foreach item=item from=$item_group|smarty:nodefaults}}
								<option value="{{$item.postfix}}">{{$item.title}}</option>
							{{/foreach}}
				...
				{{if $smarty.session.userdata.is_expert_mode==0}}
					<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_format_video_duration_hint}}</span>
				{{/if}}
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="de_control">
				<table class="control_group">
					<tr>
						<td>
							<div class="de_lv_pair"><input type="checkbox" name="recreate_overview_screenshots" value="1"/> <label>{{$lang.videos.mass_edit_videos_field_overview_screenshots_recreate}}</label></div>
							{{if $smarty.session.userdata.is_expert_mode==0}}
								<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_overview_screenshots_recreate_hint}}</span>
							{{/if}}
						</td>
					</tr>
					<tr>
						<td>
							<div class="de_lv_pair"><input type="checkbox" name="delete_overview_screenshots" value="1"/> <label>{{$lang.videos.mass_edit_videos_field_overview_screenshots_delete}}</label></div>
							{{if $smarty.session.userdata.is_expert_mode==0}}
								<br/><span class="de_hint">{{$lang.videos.mass_edit_videos_field_overview_screenshots_delete_hint}}</span>
							{{/if}}
						</td>
					</tr>
				</table>
					...
					<tr>
						...
						<td>
							{{foreach item="item" from=$list_formats_screenshots_overview|smarty:nodefaults}}
								<div class="de_lv_pair"><input type="checkbox" name="screenshot_format_recreate_ids[]" value="{{$item.format_screenshot_id}}"/><label>{{$item.title}}</label></div>
							{{/foreach}}
						</td>
					</tr>
					<tr>
		...
		<tr>
			<td class="de_separator" colspan="2"><div>{{$lang.videos.mass_edit_videos_divider_rotator}}</div></td>
		</tr>
		<tr>
			<td class="de_label">{{$lang.videos.mass_edit_videos_field_main_stats}}:</td>
			<td class="de_control">
				<div class="de_lv_pair"><input type="checkbox" name="rotator_reset_main_stats" value="1"/> <label>{{$lang.videos.mass_edit_videos_field_main_stats_reset}}</label></div>
			</td>
		</tr>
		<tr>
			<td class="de_label">{{$lang.videos.mass_edit_videos_field_screenshots_stats}}:</td>
			<td class="de_control">
				<div class="de_lv_pair"><input type="checkbox" name="rotator_reset_screenshots_stats" value="1"/> <label>{{$lang.videos.mass_edit_videos_field_screenshots_stats_reset}}</label></div>
			</td>
		</tr>
		{{if count($list_post_process_plugins)>0}}
			<tr>
				<td class="de_separator" colspan="2"><div>{{$lang.videos.mass_edit_videos_divider_plugins}}</div></td>
			</tr>
			<tr>
				...
				<td class="de_control">
					<table class="control_group">
						{{foreach item=item from=$list_post_process_plugins|smarty:nodefaults}}
							<tr><td>
								<div class="de_lv_pair"><input type="checkbox" name="post_process_plugins[]" value="{{$item.plugin_id}}"/> <label>{{$lang.videos.mass_edit_videos_field_plugins_execute|replace:"%1%":$item.title}}</label></div>
							</td></tr>
						{{/foreach}}
					</table>
				</td>
