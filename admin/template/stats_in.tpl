...
<div class="dg_wrapper">
	<form action="{{$page_name}}" method="get" class="form_dgf">
		<div class="dgf">
			<table>
				<tr>
					...
					<td class="dgf_label">{{$lang.stats.incoming_filter_group_by}}:</td>
					<td class="dgf_control">
						<select name="se_group_by" class="dgf_switcher">
							<option value="date" {{if $smarty.session.save.$page_name.se_group_by=='date'}}selected="selected"{{/if}}>{{$lang.stats.incoming_filter_group_by_date}}</option>
							<option value="referer" {{if $smarty.session.save.$page_name.se_group_by=='referer'}}selected="selected"{{/if}}>{{$lang.stats.incoming_filter_group_by_referer}}</option>
							<option value="country" {{if $smarty.session.save.$page_name.se_group_by=='country'}}selected="selected"{{/if}}>{{$lang.stats.incoming_filter_group_by_country}}</option>
							<option value="device" {{if $smarty.session.save.$page_name.se_group_by=='device'}}selected="selected"{{/if}}>{{$lang.stats.incoming_filter_group_by_device}}</option>
						</select>
					</td>
					<td class="dgf_control">
		...
		<div class="dgf dgf_advanced_filters {{if $table_filtered==0}}hidden{{/if}}">
			...
			<table class="dgf_filter">
				<tr>
					<td class="dgf_label {{if $smarty.session.save.$page_name.se_country!=''}}dgf_selected{{/if}}">{{$lang.stats.incoming_field_country}}:</td>
					<td class="dgf_control">
						<div class="insight">
							<div class="js_params">
