...
if ($_SESSION['save'][$page_name]['se_group_by'] <> 'video')
{
...
{
	$table_fields[] = array('id' => 'video',           'title' => $lang['stats']['videos_field_video'],               'is_default' => 1, 'type' => 'refid', 'link' => 'videos.php?action=change&item_id=%id%', 'link_id' => 'video_id', 'permission' => 'videos|view');
	$table_fields[] = array('id' => 'rating',          'title' => $lang['stats']['videos_field_rating'],              'is_default' => 1, 'type' => 'float', 'ifdisable_zero' => 1);
	$table_fields[] = array('id' => 'rating_amount',   'title' => $lang['stats']['videos_field_rating_amount'],       'is_default' => 1, 'type' => 'number', 'ifdisable_zero' => 1);
	$table_fields[] = array('id' => 'viewed',          'title' => $lang['stats']['videos_field_video_viewed'],        'is_default' => 1, 'type' => 'number', 'ifdisable_zero' => 1);
	$table_fields[] = array('id' => 'player_viewed',   'title' => $lang['stats']['videos_field_video_viewed_player'], 'is_default' => 1, 'type' => 'number', 'ifdisable_zero' => 1);
	$table_fields[] = array('id' => 'unique_viewed',   'title' => $lang['stats']['videos_field_video_viewed_unique'], 'is_default' => 1, 'type' => 'number', 'ifdisable_zero' => 1);
	$table_fields[] = array('id' => 'embed_requested', 'title' => $lang['stats']['videos_field_embed_requested'],     'is_default' => 1, 'type' => 'number', 'ifdisable_zero' => 1);
	$table_fields[] = array('id' => 'files_requested', 'title' => $lang['stats']['videos_field_files_requested'],     'is_default' => 1, 'type' => 'number', 'ifdisable_zero' => 1);
} else
{
