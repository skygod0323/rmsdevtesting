...
$list_grouping = 'country';

$table_fields = array();

$table_fields[] = array('id' => 'country',           'title' => $lang['stats']['incoming_field_country'],          'is_default' => 1, 'type' => 'text', 'zero_label' => '-', 'link' => 'stats_in.php?no_filter=true&se_country=%id%', 'link_id' => 'country');
...
$smarty->assign('page_title', $lang['stats']['submenu_option_stats_country']);
