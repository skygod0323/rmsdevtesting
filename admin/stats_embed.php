...
$table_fields = array();
$table_fields[] = array('id' => 'domain', 'title' => $lang['stats']['embed_field_domain'], 'is_default' => 1, 'type' => 'text', 'zero_label' => $lang['stats']['embed_field_domain_empty']);
$table_fields[] = array('id' => 'amount', 'title' => $lang['stats']['embed_field_total'], 'is_default' => 1, 'type' => 'traffic', 'ifdisable_zero' => 1);
...
$table_name = "$config[tables_prefix_multi]stats_embed";

$table_selector = "$table_name.domain, sum($table_name.amount) as amount";
$table_summary_selector = "sum($table_name.amount) as amount";
$table_summary_field_name = "domain";
$table_projector = $table_name;
$table_group_by = "$table_name.domain";
...
$smarty->assign('page_title', $lang['stats']['submenu_option_stats_embed']);
