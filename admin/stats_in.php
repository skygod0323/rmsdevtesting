...
if ($list_grouping == "date" || $list_grouping == "referer" || $list_grouping == "country" || $list_grouping == "device")
{
	...
	$table_fields[] = array('id' => 'view_player_amount', 'title' => $lang['stats']['incoming_field_video_play'],       'is_default' => 0, 'type' => 'traffic', 'ifdisable_zero' => 1);
	$table_fields[] = array('id' => 'view_player_ratio',  'title' => $lang['stats']['incoming_field_video_play_ratio'], 'is_default' => 0, 'type' => 'double',  'ifdisable_zero' => 1);
