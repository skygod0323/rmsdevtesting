...
{
	$table_fields[] = array('id' => 'user',          'title' => $lang['stats']['users_content_field_user'],          'is_default' => 1, 'type' => 'user');
	$table_fields[] = array('id' => 'status_id',     'title' => $lang['stats']['users_content_field_status'],        'is_default' => 1, 'type' => 'choice', 'values' => $list_status_values);
	$table_fields[] = array('id' => 'reseller_code', 'title' => $lang['stats']['users_content_field_reseller_code'], 'is_default' => 0, 'type' => 'text');
...
} else
{
	...
	$table_fields[] = array('id' => 'status_id',     'title' => $lang['stats']['users_content_field_status'],        'is_default' => 1, 'type' => 'choice', 'values' => $list_status_values);
	$table_fields[] = array('id' => 'reseller_code', 'title' => $lang['stats']['users_content_field_reseller_code'], 'is_default' => 0, 'type' => 'text');
	$table_fields[] = array('id' => 'object',        'title' => $lang['stats']['users_content_field_object'],        'is_default' => 1, 'type' => 'object');
