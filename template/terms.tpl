{{assign var="page_title" value=$lang.html.static_html_title.terms}}
{{assign var="page_description" value=$lang.html.static_html_description.terms}}
{{assign var="page_keywords" value=$lang.html.static_html_keywords.terms}}
{{assign var="page_canonical" value=$lang.urls.terms}}

{{include file="include_header_general.tpl"}}

<div class="text-block">
	<div class="container">
		<h1 class="title">{{$lang.html.static_html_title.terms}}</h1>
		<h2>1. ACCEPTANCE</h2>

		<p>
			By using and/or visiting the {{$lang.project_name}} website (collectively, including but not limited to all
			Content, Uploads and User Submissions available through {{$config.project_licence_domain}},
			"{{$lang.project_name}}", the website) you agree to the terms and conditions contained herin and the terms
			and conditions of {{$lang.project_name}}'s privacy policy incorporated herin, and all future amendments and
			...
			not use {{$config.project_licence_domain}}.
		</p>

		<p>
			The terms and conditions of this Agreement are subject to change by {{$lang.project_name}} at any time in
			...
			use {{$config.project_licence_domain}}.
		</p>

		<p>
			The terms and conditions contained herein apply to all users of {{$lang.project_name}} whether a 'visitor'
			or a 'member' and you are only authorized to use {{$config.project_licence_domain}} if you agree to abide
		...
		<p>
			The {{$lang.project_name}} website allows for uploading, sharing and general viewing various types of
			content allowing registered and unregistered users to share and view visual depictions of adult content,
			including sexually explicit images. In addition, {{$lang.project_name}} contains video content, information
			and other materials posted/uploaded by users. {{$lang.project_name}} allows its users to view the Content
			and Website subject to the terms and conditions of this Agreement.
		</p>

		<p>
			The {{$lang.project_name}} website may also contain certain links to third party websites which are in no
			way owned or controlled by {{$lang.project_name}}. {{$lang.project_name}} assumes no responsibility for the
			content, privacy policies, practices of any and all third party websites. {{$lang.project_name}} cannot
			censor or edit the content of third party sites. You acknowledge that {{$lang.project_name}} will not be
			liable for any and all liability arising for your use of any third-party website.
		</p>

		<p>
			{{$lang.project_name}} is for your personal use and shall not be used for any commercial
			endeavor except those specifically endorsed or approved by {{$config.project_licence_domain}}. Any illegal
			and/or unauthorized use of {{$lang.project_name}} is prohibited including but not limited to collecting
			usernames and e-mail addresses for sending unsolicited emails or unauthorized framing or linking to the
			{{$lang.project_name}} website is prohibited.
		</p>
		...
		<p>
			...
			of posting, uploading, publishing, transmitting or other making them available on {{$lang.project_name}}.
			You agree that you shall not (nor others using your account) post, upload, publish, transmit or make
			available in any way on {{$lang.project_name}} content which is illegal, unlawful, harassing, harmful,
			...
			transmit or make available in any way on {{$lang.project_name}} software containing viruses or any other
			...
			in any way on {{$lang.project_name}} content which is intentionally or unintentionally violating any
			...
			your account) post, upload, publish, transmit or make available in any way on {{$lang.project_name}}
			content depicting illegal activities, promote or depict physical harm or injury against any group or
			individual, or promote or depict any act of cruelty to animals; You agree not to use {{$lang.project_name}}
			in any way that exposes {{$lang.project_name}} to criminal or civil liability.
		</p>

		<p>
			You agree that {{$lang.project_name}} shall have the right to determine in its sole and unfettered
		...
		<p>
			The Content contained on the {{$lang.project_name}} with the exception of User Submissions including but
			...
			{{$lang.project_name}}, subject to copyright and other intellectual property rights under United States,
			...
			prior written consent of the respective owners. {{$lang.project_name}} reserves all rights not expressly
			...
			security related features of the {{$lang.project_name}} or features that prevent or restrict use or copying
			of any Content or enforce limitations on use of the {{$lang.project_name}} Website or the Content therein.
		</p>

		<h2>6. USER SUBMISSIONS</h2>

		<p>
			{{$lang.project_name}} permits the submission of video and other communications and the hosting, sharing
			and publishing of such user submissions. You understand that whether or not such User Submissions are
			published and/or uploaded, {{$lang.project_name}} does not guarantee any confidentiality with respect to
			any submissions.
		</p>

		<p>
			{{$lang.project_name}} allows/permits you to link to materials on the Website for personal, non-commercial
			purposes only. More over, {{$lang.project_name}} provides an "Embeddable Player" feature, which you may
			incorporate into your own personal, non-commercial websites for use in accessing the materials on the
			Website, provided that you include a prominent link back to the {{$lang.project_name}} website on the
			pages containing the Embeddable Player. {{$lang.project_name}} reserves the right to discontinue any aspect
			of the {{$lang.project_name}} website at any time. In addition, you may not modify, build upon or block any
		...
		<p>
			...
			authorize {{$lang.project_name}} to use all trademarks, copyrights, trade secrets, patents, or other
			...
			{{$lang.project_name}}, you hereby grant {{$lang.project_name}} a worldwide, non-exclusive, royalty-free,
			sublicenseable and transferable license to use, reproduce, distribute, prepare derivative works of,
			display, and perform the User Submissions in connection with the {{$lang.project_name}} Website and
			{{$lang.project_name}}'s (and its successor's) business, including without limitation for promoting and
			redistributing part or all of the {{$lang.project_name}} Website (and derivative works thereof) in any
			media formats and through any media channels. You also hereby grant each user of the {{$lang.project_name}}
			...
			terminates once you remove or delete a User Submission from the {{$lang.project_name}} Website.
		</p>
		...
		<ul>
			<li>
				...
				have permission from their rightful owner to post the material and to grant {{$lang.project_name}} all
				of the license rights granted herein;
			</li>
			<li>
				publish falsehoods or misrepresentations that could damage {{$lang.project_name}} or any third party;
			</li>
			<li>
		...
		<p>
			{{$lang.project_name}} does not endorse any User Submission or any opinion, recommendation, or advice
			expressed therein, and {{$lang.project_name}} expressly disclaims any and all liability in connection with
			User Submissions. {{$lang.project_name}} does not permit copyright infringing activities and infringement
			of intellectual property rights on its Website, and {{$lang.project_name}} will remove all Content and User
			Submissions if properly notified that such Content or User Submission infringes on another's intellectual
			property rights. {{$lang.project_name}} reserves the right to remove Content and User Submissions without
			prior notice or delay. {{$lang.project_name}} will also terminate a User's access to its Website, if they
			are determined to be an infringer. While pornographic and adult content are accepted,
			{{$lang.project_name}} also reserves the right to decide in its sole and unfettered discretion, whether
			...
			obscene or defamatory material, or excessive length. {{$lang.project_name}} may remove such User
		...
		<p>
			You understand and acknowledge that when using {{$config.project_licence_domain}}, you will be exposed to
			User Submissions from a variety of sources, and that {{$lang.project_name}} is not responsible for the
			...
			rights or remedies you have or may have against {{$lang.project_name}} with respect thereto, and agree to
			indemnify and hold {{$lang.project_name}}, its Owners, affiliates, operators, and/or licensors, harmless to
			the fullest extent allowed by law regarding all matters related to your use of the website.
		</p>

		<p>
			You agree that {{$lang.project_name}} may at its sole discretion have the right to refuse to publish,
			remove, or block access to any User Submission that is available via the Website or other
			{{$lang.project_name}} network or services at any time, for any reason, or for no reason at all, with or
			without notice.
		</p>

		<p>
			{{$lang.project_name}} provides its website as a service to its users. However, {{$lang.project_name}}
			assumes no responsibility whatsoever for monitoring the {{$lang.project_name}} Services for inappropriate
			content or conduct. If at any time {{$lang.project_name}} chooses, in its sole discretion, to monitor the
			{{$lang.project_name}} Services, however, {{$lang.project_name}} assumes no responsibility for the content,
			no obligation to modify or remove any inappropriate content, and no responsibility for the conduct of the
			User submitting any such content. {{$lang.project_name}} may review and delete any User Submissions that,
		...
		<p>
			You further understand, acknowledge, agree and specifically authorize {{$lang.project_name}} to use, reuse,
			post, publish or upload any User Submissions on any other website owned or controlled by
			{{$lang.project_name}} or on any website with whom {{$lang.project_name}} has an agreement with respect to
			User Submissions content or sponsor uploaded video. In addition, User submission is deemed to include any
			sponsored or otherwise branded uploaded videos. {{$lang.project_name}} reserves the right to determine as
		...
		<p>
			A User's access to {{$lang.project_name}} will be terminated if, under appropriate conditions, the User is
			determined to infringe repeatedly. {{$lang.project_name}} reserves the right to decide whether Content or
		...
		<p>
			{{$lang.project_name}} abides by a ZERO TOLERANCE policy relating to any illegal content. Child Pornography,
			bestiality, rape, torture, snuff, death and/or any other type of obscene and/or illegal material shall not
			be tolerated by {{$lang.project_name}}. {{$lang.project_name}} shall not condone child pornography and will
		...
		<p>
			You acknowledge that {{$lang.project_name}} reserves the right to charge for {{$lang.project_name}}
			services and to change its fees from time to time in its discretion. Further more, in the event
			{{$lang.project_name}} terminates your rights to use the website because of a breach of this Agreement, you
		...
		<p>
			You represent and warrant that all of the information provided by you to {{$lang.project_name}} to
			participate in the {{$lang.project_name}} website is accurate and current and you have all necessary right,
			power, and authority to enter into this Agreement and to perform the acts required of you hereunder.
		</p>

		<p>
			As a condition to using the {{$lang.project_name}}, you must agree to the terms of {{$lang.project_name}}'s
			...
			further acknowledge and agree that other data collected and maintained by {{$lang.project_name}} with
			regard to its users may be disclosed in accordance with the {{$lang.project_name}} Privacy Policy.
		</p>

		<h2>11. WARRANTY DISCLAIMER</h2>

		<p>
			YOU AGREE THAT YOUR USE OF THE {{$lang.project_name|strtoupper}} WEBSITE SHALL BE AT YOUR SOLE RISK. TO THE
			FULLEST EXTENT PERMITTED BY LAW, {{$config.project_licence_domain|strtoupper}}, ITS OFFICERS, DIRECTORS,
			EMPLOYEES, AND AGENTS DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE WEBSITE AND YOUR
			USE THEREOF. {{$config.project_licence_domain|strtoupper}} MAKES NO WARRANTIES OR REPRESENTATIONS ABOUT
			...
			{{$lang.project_name|strtoupper}} WEBSITE. {{$lang.project_name|strtoupper}} DOES NOT WARRANT, ENDORSE,
			GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY
			THROUGH THE {{$lang.project_name|strtoupper}} WEBSITE OR ANY HYPERLINKED WEBSITE OR FEATURED IN ANY BANNER
			OR OTHER ADVERTISING, AND {{$lang.project_name|strtoupper}} WILL NOT BE A PARTY TO OR IN ANY WAY BE
			...
			{{$lang.project_name|strtoupper}} SHALL NOT BE LIABLE FOR USER SUBMISSIONS OR THE DEFAMATORY, OFFENSIVE, OR
		...
		<p>
			IN NO EVENT SHALL {{$lang.project_name|strtoupper}}, ITS OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS, BE
			...
			CONTENT POSTED, EMAILED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE {{$lang.project_name|strtoupper}}
		...
		<p>
			You agree to defend, indemnify and hold harmless {{$lang.project_name}}, its parent corporation, officers,
		...
		<ul>
			<li>
				your use of and access to the {{$lang.project_name}} Website;
			</li>
			<li>
		...
		<p>
			...
			transferred or assigned by you, but may be assigned by {{$lang.project_name}} without restriction.
		</p>
