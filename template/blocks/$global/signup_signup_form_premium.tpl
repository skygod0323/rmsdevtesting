						...
						<div class="left">
							{{if $lang.signup.generated_credentials!='true'}}
								<div class="modal__window__form cfx">
									...
									<div class="modal__window__row">
										<label for="signup_country_id" class="modal__window__label required">{{$lang.signup.field_country_id}} (*):</label>
										<div class="relative ss">
											<select id="signup_country_id" class="input" name="country_id">
									...
									<div class="row">
										<label for="signup_custom1" class="modal__window__label required">{{$lang.signup.field_charity_id}} (*):</label>
										<div class="relative">
											<select id="signup_custom1" class="input" name="custom1">
												<option value="">Select...</option>
