<div id="{{$block_uid}}">
	{{if $list_type=='tags'}}
		...
		{{assign var="pagination_direct_link" value=$lang.urls.videos_by_tag|replace:"%DIR%":$tag_info.tag_dir|replace:"%ID%":$tag_info.tag_id}}
	{{elseif $list_type=='categories'}}
		...
		{{assign var="pagination_direct_link" value=$lang.urls.videos_by_category|replace:"%DIR%":$category_info.dir|replace:"%ID%":$category_info.category_id}}
	{{elseif $list_type=='models'}}
		...
		{{assign var="pagination_direct_link" value=$lang.urls.videos_by_model|replace:"%DIR%":$model_info.dir|replace:"%ID%":$model_info.model_id}}
	{{else}}
		{{assign var="list_videos_title" value=$lang.videos.list_title_by_sorting|replace:"%1%":$lang.videos.list_sorting[$sort_by]}}
		{{assign var="pagination_direct_link" value=$lang.urls.videos}}
	{{/if}}
