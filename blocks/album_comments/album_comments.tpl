{{if $album_info.album_id>0}}
	<div class="comments">
		...
		<div class="block-comments" data-block-id="{{$block_uid}}">
								...
								<div class="row">
									...
									{{else}}
										<div class="captcha-control">
											<img src="{{$config.project_url}}/?mode=async&amp;function=show_security_code&amp;captcha_id=album_comments&amp;rand={{$smarty.now}}" alt="Captcha"/>
			...
			{{else}}
				<div class="notice">You can't add comments to this album</div>
			{{/if}}
