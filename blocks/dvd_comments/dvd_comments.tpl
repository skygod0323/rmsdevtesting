{{if $dvd_info.dvd_id>0}}
	<div class="comments">
		...
		<div class="block-comments" data-block-id="{{$block_uid}}">
					...
					<div class="block-new-comment">
						...
						<div>
								...
								<div class="row">
									...
									{{else}}
										<div class="captcha-control">
											<img src="{{$config.project_url}}/?mode=async&amp;function=show_security_code&amp;captcha_id=dvd_comments&amp;rand={{$smarty.now}}" alt="Captcha"/>
							...
							<div class="buttons">
								...
								<input type="hidden" name="dvd_id" value="{{$dvd_info.dvd_id}}">
			...
			{{else}}
				<div class="notice">You can't add comments to this channel</div>
			{{/if}}
