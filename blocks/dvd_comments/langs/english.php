...
$lang['dvd_comments']['params']['var_dvd_dir']      = "URL parameter, which provides DVD directory.";
$lang['dvd_comments']['params']['var_dvd_id']       = "URL parameter, which provides DVD ID. Will be used instead of DVD directory if specified and is not empty.";
$lang['dvd_comments']['params']['min_length']       = "Limits the minimum comment length allowed to be posted.";
$lang['dvd_comments']['params']['need_approve']     = "Configures whether new comments should be approved by administrator before they are displayed on website.";
$lang['dvd_comments']['params']['allow_anonymous']  = "Enables comments from anonymous users.";
$lang['dvd_comments']['params']['use_captcha']      = "Configures whether captcha protection should be used.";
$lang['dvd_comments']['params']['allow_editing']    = "Allows users edit their comments.";
$lang['dvd_comments']['params']['match_locale']     = "If this parameter is enabled, block will show only comments posted with the current KVS locale.";

$lang['dvd_comments']['values']['use_captcha']['1']         = "Enable for anonymous users only";
$lang['dvd_comments']['values']['use_captcha']['2']         = "Enable for all users";
$lang['dvd_comments']['values']['need_approve']['1']        = "Approval required for anonymous only";
$lang['dvd_comments']['values']['need_approve']['2']        = "Approval required for all comments";
$lang['dvd_comments']['values']['sort_by']['comment_id']    = "Comment ID";
$lang['dvd_comments']['values']['sort_by']['user_id']       = "User ID";
$lang['dvd_comments']['values']['sort_by']['comment']       = "Comment text";
$lang['dvd_comments']['values']['sort_by']['rating']        = "Rating";
$lang['dvd_comments']['values']['sort_by']['added_date']    = "Creation date";
$lang['dvd_comments']['values']['sort_by']['rand()']        = "Random";

$lang['dvd_comments']['block_short_desc'] = "Provides comments functionality for DVDs / channels / TV seasons";

$lang['dvd_comments']['block_desc'] = "
	Block displays comments for the given DVD / channel / TV season (context object) and provides ability to post new
...
$lang['dvd_comments']['block_examples'] = "
	[kt|b]Display all comments for the DVD with directory value 'my_dvd'[/kt|b]
	[kt|br][kt|br]
	...
	[kt|b]Display 8 comments per page for the DVD with ID '11'[/kt|b]
	[kt|br][kt|br]
